...
Trainer.prototype.train = function(_data) {
  var data2 = Trainer.prototype.appendCleanTokens(_data)
  var freqs = Trainer.prototype.getWordFreq(data2)
  var tfidf = Trainer.prototype.getTFIDF(freqs)
